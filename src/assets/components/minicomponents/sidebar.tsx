    ...
    <div className="sidebar h-screen w-[4rem] flex flex-col justify-between items-center py-4 bg-gradient-to-r from-orange-50 to-slate-50">
      ...
      <div className="sidebar_mid h-full flex flex-col justify-center items-center gap-4">
        <div className="sidebar_button">
          <Button
            className={
              "bg-transparent border-0 hover:bg-accent/20 p-0 w-10 h-10 cursor-pointer " +
              (tabSelected === "library" ? "bg-sidebar-accent" : "")
            }
            onClick={() => {
              setTabSelected("library");
            }}
          >
        ...
        <div className="sidebar_button">
          <Button
            className={
              "bg-transparent border-0 hover:bg-accent/20 p-0 w-10 h-10 cursor-pointer " +
              (tabSelected === "calendar" ? "bg-sidebar-accent" : "")
            }
            onClick={() => {
        ...
        <div className="sidebar_button">
          <Button
            className={
              "bg-transparent border-0 hover:bg-accent/20 p-0 w-10 h-10 cursor-pointer " +
              (tabSelected === "bookmarks" ? "bg-sidebar-accent" : "")
            }
            onClick={() => {
